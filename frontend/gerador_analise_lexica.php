<div class="form">
    <form method="GET">
        <textarea name="string" id="string_txt"><?php if(isset($_GET['string'])){echo $_GET['string']; }else{ ?>se (a==b){escreva(c)}<?php } ?></textarea>
        <div class="flex">
            <button type="submit">Gerar Análise Léxica</button>
            <a href="./" class="red">
